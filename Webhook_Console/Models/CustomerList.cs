...
namespace Webhook_Console.Models
{
    ...
    public class Contact
    {
        ...
        public object JobTitle { get; set; } = new();
        public string? Phone { get; set; }
        public object MobilePhone { get; set; } = new();
        public object Fax { get; set; } = new();
        public string? Email { get; set; }
        public object Website { get; set; } = new();
    ...
    public class CustomerList
    {
        ...
        public object SalesRepresentative { get; set; } = new();
        ...
        public object AttributeSet { get; set; } = new();
    ...
    public class CustomerListModel
    {
        ...
        public List<CustomerList> CustomerList { get; set; } = new();
    }
